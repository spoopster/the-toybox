...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, replaceBlueFlySpider, FamiliarVariant.BLUE_FLY)
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, replaceBlueFlySpider, FamiliarVariant.BLUE_SPIDER)

if(FiendFolio) then
    mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, replaceBlueFlySpider, FamiliarVariant.ATTACK_SKUZZ)
end