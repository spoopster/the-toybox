...
local function abelFireTear(_, tear)
    ...
    if(not (fam and fam.Player and mod:playerHasLimitBreak(fam.Player))) then return end
...
mod:AddCallback(ModCallbacks.MC_POST_FAMILIAR_FIRE_PROJECTILE, abelFireTear, FamiliarVariant.ABEL)