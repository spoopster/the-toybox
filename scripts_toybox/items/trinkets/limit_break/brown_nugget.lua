...
local function familiarUpdate(_, familiar)
    ...
    if(sprite:GetAnimation()=="Fly" and sprite:GetFrame()==16) then
        local target = ToyboxMod:closestEnemy(familiar.Position)
...
ToyboxMod:AddCallback(ModCallbacks.MC_PRE_FAMILIAR_UPDATE, familiarUpdate, FamiliarVariant.BROWN_NUGGET_POOTER)