...
ENUM_EVILFAM_PICKER:AddOutcomeFloat(CollectibleType.COLLECTIBLE_INCUBUS, 0.75, ENUM_PICKER_WEIGHTFACT)
ENUM_EVILFAM_PICKER:AddOutcomeFloat(CollectibleType.COLLECTIBLE_SUCCUBUS, 0.25, ENUM_PICKER_WEIGHTFACT)
ENUM_EVILFAM_PICKER:AddOutcomeFloat(CollectibleType.COLLECTIBLE_MULTIDIMENSIONAL_BABY, 0.75, ENUM_PICKER_WEIGHTFACT)
