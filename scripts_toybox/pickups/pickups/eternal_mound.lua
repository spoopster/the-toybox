...
mod:AddCallback(ModCallbacks.MC_POST_PICKUP_UPDATE, moundUpdate, mod.PICKUP_VARIANT.ETERNAL_MOUND)
...
mod:AddCallback(ModCallbacks.MC_PRE_PICKUP_COLLISION, preMoundCollision, mod.PICKUP_VARIANT.ETERNAL_MOUND)