...
MinimapAPI:AddIcon("ToyboxTravelVoucherCard", ICONS_SPRITE, "IconCards", 14)
...
MinimapAPI:AddIcon("ToyboxAhauFlowerUpgrade", ICONS_SPRITE, "IconMisc", 0)
...
MinimapAPI:AddPickup("ToyboxTravelVoucherCard","ToyboxTravelVoucherCard",5,300,-1,MinimapAPI.PickupNotCollected,"cards",10001,function(p) return not isCanTripped() and iconf:GetCard(p.SubType).PickupSubtype == 2806 end)
