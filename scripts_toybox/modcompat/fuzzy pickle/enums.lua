...
ToyboxMod:addReferenceItem(ToyboxMod.COLLECTIBLE_BRUNCH, "Dr. Seuss", true)
ToyboxMod:addReferenceItem(ToyboxMod.COLLECTIBLE_OIL_PAINTING, "Leonardo Da Vinci")
ToyboxMod:addReferenceItem(ToyboxMod.COLLECTIBLE_PAPER_PLATE, "Five Nights at Freddy's 2")
ToyboxMod:addReferenceItem(ToyboxMod.COLLECTIBLE_COLORING_BOOK, "The Binding of Isaac", true)
...
ToyboxMod:addReferenceTrinket(ToyboxMod.TRINKET_MISPRINT, "Balatro", true)
ToyboxMod:addReferenceTrinket(ToyboxMod.TRINKET_GASOLINE, "Kanye West", true)
ToyboxMod:addReferenceTrinket(ToyboxMod.TRINKET_ZAP_CAP, "Desktop Survivors 98")
ToyboxMod:addReferenceTrinket(ToyboxMod.TRINKET_DARK_NEBULA, "Kirby: Squeak Squad")
